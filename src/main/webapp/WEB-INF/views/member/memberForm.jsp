		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td><input type="radio" name="member_gender" value="102" />여성<span style="padding-left:120px"></span>
				...
				<tr class="dot_line">
					...
					<select name="birth_year">
					   <c:forEach var="year" begin="1921" end="2020">
					       	<c:choose>
					          <c:when test="${year==2000}">
				...
				<tr class="dot_line">
					...
					<td><input size="10px" type="text" name="email1" /> @ <input size="10px" type="text"  name="email2" /> 
						  <select name="email2" onChange=""	title="직접입력">
									<option value="non" selected>직접입력</option>
						  ...
						  <br><br><input type="checkbox" name="email_yn" value="Y" checked/> 쇼핑몰에서 발송하는 e-mail을 수신합니다.</td>
				</tr>
				<tr class="dot_line">
